...
// ⚡ Bolt Optimization: Pre-compute a Set of lowercased current usernames
// This changes an O(N*M) nested loop search into an O(N+M) set lookup.
// Expected performance impact: Reduces search time significantly for large user arrays.
