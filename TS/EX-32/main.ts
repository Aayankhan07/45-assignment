...
// Converted O(n²) array search to O(n) Set lookup
// Pre-computing the lowercase usernames creates a fast O(1) lookup map,
// significantly improving performance for large user lists.
