...
// ⚡ Bolt Optimization: Cache current users in lowercase using a Set for O(1) lookup
// This prevents calling toLowerCase() on current_user elements repeatedly
// and changes the search complexity from O(N*M) to O(N+M)
