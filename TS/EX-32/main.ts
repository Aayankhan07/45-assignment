...
// Pre-compute a Set of lowercase current usernames to reduce lookup complexity from O(n^2) to O(n)
// This avoids calling .toLowerCase() on the current users repeatedly during the loop.
