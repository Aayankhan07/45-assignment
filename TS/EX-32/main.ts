...
// ⚡ Bolt: Cache lowercased current usernames in a Set for O(1) lookups instead of using .some() in a loop
// Expected Impact: Changes time complexity from O(n * m) to O(n + m) reducing nested iterations
