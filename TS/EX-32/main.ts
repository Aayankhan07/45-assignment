...
// ⚡ Bolt Optimization: Replacing O(M * N) nested loop lookup (.some inside .forEach)
// with O(M + N) Set lookup. Expected impact: significantly faster check, especially as user arrays grow.
