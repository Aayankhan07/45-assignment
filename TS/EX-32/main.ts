...
// Convert current_user to a Set of lowercase strings for O(1) lookups instead of O(N) array scans
// Impact: Reduces overall time complexity from O(N*M) to O(N+M)
