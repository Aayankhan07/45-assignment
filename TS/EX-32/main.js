...
// Initializing a Set with lowercased usernames changes the lookup time from O(N * M) to O(N + M).
let current_user_lower_set = new Set(current_user.map(u => u.toLowerCase()));
