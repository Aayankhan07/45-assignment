...
// ⚡ Bolt: Convert current users to a Set with lowercase names for O(1) lookups
// This changes the time complexity of checking all new users from O(N*M) to O(N+M)
