...
// Convert current_user to a Set of lowercase strings beforehand.
// This changes the lookup time in the loop from O(M * N) to O(M + N).
// It also avoids calling .toLowerCase() on current_user elements repeatedly.
