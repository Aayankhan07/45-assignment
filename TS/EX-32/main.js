...
// Convert current users to a Set of lowercase strings once (O(N))
// This changes the nested loop lookup O(N*M) to O(N+M)
// Expected impact: Significant speedup for larger arrays of users
