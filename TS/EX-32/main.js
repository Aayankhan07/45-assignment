...
// ⚡ Bolt Optimization: Use a Set for O(1) lookups instead of nested loops (O(N*M) -> O(N+M)).
// This reduces time complexity and avoids repeatedly calling `.toLowerCase()` on the same strings.
